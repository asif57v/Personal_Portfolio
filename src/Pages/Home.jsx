...
const TECH_STACK = ["C", "C++", "React.js", "Node.js", "Express.js", "Mongo Db", "Javascript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/asif57v" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/asif-mansoori-771900293" },
  { icon: Mail, link: "mailto:asifmansoori076@gmail.com" },
];
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 pl-4 sm:pl-6 lg:pl-12"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Entry-level Software Engineer with strong fundamentals in Data Structures, OOP, DBMS and Operating Systems. Skilled in problem solving, debugging, and building REST APIs.
                </p>
